...
const HotelSearchPage = () => {
  ...
  const mockReviews = [
    { author: "Sarah M.", rating: 5, text: "Absolutely stunning location with incredible service. The overwater villa was a dream come true!", verified: true },
    { author: "James K.", rating: 4, text: "Great hotel, beautiful beaches and excellent food. Would definitely come back.", verified: true },
    { author: "Emma L.", rating: 5, text: "Perfect honeymoon destination. Staff went above and beyond to make our stay special.", verified: false }
  ];
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
            ...
            <SaveSearchActions 
              searchCriteria={{
                ...
                checkIn: searchParams.get("checkIn") || "",
                checkOut: searchParams.get("checkOut") || "",
                rooms: [{ adults: parseInt(searchParams.get("guests") || "2"), children: [] }]
              }}
            />
          </div>
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h3 className="text-lg font-semibold">What guests are saying about {searchParams.get("destination")}</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            {mockReviews.map((review, index) => (
              <GuestReviewSnippet key={index} review={review} />
            ))}
          </div>
          <BestPriceGuarantee />
        </div>
        ...
        <SearchResultsLayout
          results={filteredAndSortedHotels}
          loading={loading}
          filters={filters}
                ...
                <div key={hotel.id} className="relative">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-2">
                      {index === 0 && (
                        <UrgencyBadge type="rooms_left" value={3} />
                      )}
                      {hotel.deals && (
                        <UrgencyBadge 
                          type="flash_deal" 
                      ...
                      {index === 1 && (
                        <UrgencyBadge type="last_booking" value={7} />
                      )}
                      {index === 2 && (
                        <UrgencyBadge type="high_demand" />
                      )}
                    </div>
