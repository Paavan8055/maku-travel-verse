              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    <div className={`p-4 border-2 rounded-xl cursor-pointer transition-all ${paymentMethod === 'card' ? 'border-primary bg-primary/5' : 'border-border'}`} onClick={() => setPaymentMethod('card')}>
                    ...
                    <div className={`p-4 border-2 rounded-xl cursor-pointer transition-all ${paymentMethod === 'fund' ? 'border-primary bg-primary/5' : 'border-border'}`} onClick={() => setPaymentMethod('fund')}>
                      <div className="flex items-center space-x-3">
                    ...
                    <div className={`p-4 border-2 rounded-xl cursor-pointer transition-all ${paymentMethod === 'split' ? 'border-primary bg-primary/5' : 'border-border'}`} onClick={() => setPaymentMethod('split')}>
                      <div className="flex items-center space-x-3">
                        <div className="flex">
                          <CreditCard className="h-5 w-5" />
                  ...
                  {/* Fund Balance Info */}
                  {(paymentMethod === 'fund' || paymentMethod === 'split') && <div className="bg-muted p-4 rounded-xl">
                      <div className="flex justify-between items-center mb-2">
                        <span>Available Fund Balance:</span>
                        <span className="font-bold text-primary">$1,250</span>
                      </div>
                      {paymentMethod === 'fund' && bookingDetails.total > 1250 && <p className="text-sm text-destructive">
          ...
          <div>
            <Card className="travel-card sticky top-24">
              <CardContent className="p-6">
                ...
                <Button onClick={handlePayment} disabled={!agreeToTerms || isProcessing} className="w-full mt-6 btn-primary h-12">
