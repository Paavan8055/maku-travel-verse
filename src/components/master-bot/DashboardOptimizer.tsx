...
import { OptimizationProgressIndicator } from './OptimizationProgressIndicator';
import { EnhancedOptimizationResults } from './EnhancedOptimizationResults';
...
export const DashboardOptimizer: React.FC<DashboardOptimizerProps> = ({
  ...
  const handleOptimize = (optimizationType: string) => {
    ...
    const command = `Optimize dashboard ${optimizationType} - improve loading times, enhance responsiveness, and implement performance best practices for ${optimizationType}`;
    onOptimize(command);
  };
  ...
  const handleApplyMore = () => {
    setShowResults(false);
    setSelectedOptimization('performance');
    onOptimize('Apply additional advanced optimizations - memory optimization, caching improvements, and UI performance enhancements');
  };
      ...
      <div className="space-y-6">
        {showResults ? (
          <EnhancedOptimizationResults 
            ...
            onApplyMore={handleApplyMore}
            onViewDetails={() => setShowResults(false)}
          />
        ) : (
          <>
              ...
              <Card>
                <CardContent className="p-4">
                  <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    ...
                    Last optimization completed {formatDistanceToNow(lastOptimization, { addSuffix: true })}
                  </div>
                </CardContent>
              </Card>
            )}
