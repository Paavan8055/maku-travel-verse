...
const GuestSchema = z.object({
  ...
  idDocument: z
    .string()
    .min(5, "ID document number is required")
    .transform((v) => v.toUpperCase())
      ...
      <CardContent className="p-6">
          ...
          <div>
            ...
            <Select value={all.title} onValueChange={(v) => setValue("title", v as PassengerFormData["title"], { shouldValidate: true })}>
              ...
              <SelectContent className="bg-card z-50">
                {(["MR","MRS","MS","DR","PROF"] as const).map(t => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mt-4">
          ...
          <div>
            ...
            <Input {...register("nationality")} placeholder="AUS / USA" onChange={(e)=>setValue("nationality", e.target.value.toUpperCase() as any, { shouldValidate: true })} />
          ...
          <div>
            ...
            <Input {...register("idDocument")} placeholder="Passport/ID Number" onChange={(e)=>setValue("idDocument", e.target.value.toUpperCase() as any, { shouldValidate: true })} />
