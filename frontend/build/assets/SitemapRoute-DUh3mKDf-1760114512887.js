import{r,s as o}from"./index-CvK9Qeea-1760114512887.js";const c=()=>(r.useEffect(()=>{(async()=>{try{const{data:e,error:t}=await o.functions.invoke("dynamic-sitemap");if(t){console.error("Failed to fetch sitemap:",t);return}const n=new Response(e,{headers:{"Content-Type":"application/xml; charset=utf-8","Cache-Control":"public, max-age=3600"}});document.open(),document.write(e),document.close()}catch(e){console.error("Error generating sitemap:",e);const t=`<?xml version="1.0" encoding="UTF-8"?>
