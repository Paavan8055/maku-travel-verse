...
-- Add some test bookings for the dashboard to display (using allowed booking types)
...
(
  ...
  899.00,
  'USD',
  '{"customerInfo": {"email": "diana@example.com", "firstName": "Diana", "lastName": "Wilson"}, "packageName": "Gold Coast Getaway", "checkInDate": "2025-02-14", "checkOutDate": "2025-02-17", "includes": ["hotel", "breakfast", "activities"]}',
