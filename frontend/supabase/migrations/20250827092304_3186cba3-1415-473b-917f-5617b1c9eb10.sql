-- PHASE 1: Database Cleanup & Repair (Fixed JSON casting)
-- Remove duplicate provider_health records
WITH duplicates AS (
  SELECT id, provider, 
...
-- Refresh provider_health with properly cast JSON
DELETE FROM provider_health;
INSERT INTO provider_health (provider, status, last_checked, response_time_ms, failure_count, error_count, metadata) VALUES
('amadeus-flight', 'healthy', NOW(), 150, 0, 0, '{"last_success": "2025-08-27T09:18:00Z", "circuit_breaker": "closed"}'::jsonb),
('amadeus-hotel', 'healthy', NOW(), 180, 0, 0, '{"last_success": "2025-08-27T09:18:00Z", "circuit_breaker": "closed"}'::jsonb),
('amadeus-activity', 'healthy', NOW(), 165, 0, 0, '{"last_success": "2025-08-27T09:18:00Z", "circuit_breaker": "closed"}'::jsonb),
('sabre-flight', 'degraded', NOW(), 850, 2, 1, '{"last_success": "2025-08-27T09:08:00Z", "circuit_breaker": "half-open"}'::jsonb),
('sabre-hotel', 'degraded', NOW(), 780, 1, 1, '{"last_success": "2025-08-27T09:13:00Z", "circuit_breaker": "closed"}'::jsonb),
('hotelbeds-hotel', 'degraded', NOW(), 2800, 3, 2, '{"last_success": "2025-08-27T09:03:00Z", "circuit_breaker": "closed"}'::jsonb),
('hotelbeds-activity', 'degraded', NOW(), 2650, 2, 1, '{"last_success": "2025-08-27T09:08:00Z", "circuit_breaker": "closed"}'::jsonb);