-- PHASE 1: PROVIDER CONFIGURATION CLEANUP (FINAL FIX)
...
-- Clean up provider configs - check existing columns first
INSERT INTO provider_configs (id, name, type, priority, enabled) VALUES
('amadeus', 'Amadeus', 'flight', 1, true),
('sabre-flight', 'Sabre Flight', 'flight', 2, true),
('sabre-hotel', 'Sabre Hotel', 'hotel', 2, true),
('hotelbeds-hotel', 'HotelBeds Hotel', 'hotel', 1, true),
('hotelbeds-activity', 'HotelBeds Activity', 'activity', 1, true)
