-- Seed some sample data to make the admin dashboard functional

-- Insert some sample notifications
INSERT INTO public.notifications (user_id, type, title, message, priority, read)
VALUES 
  ('00000000-0000-0000-0000-000000000000', 'system', 'System Maintenance', 'Scheduled maintenance completed successfully', 'medium', false),
  ('00000000-0000-0000-0000-000000000000', 'security', 'Security Update', 'New security patches have been applied', 'high', false),
  ('00000000-0000-0000-0000-000000000000', 'info', 'Welcome', 'Welcome to MAKU Travel admin dashboard', 'low', true);
...
-- Create some sample admin metrics cache entry
