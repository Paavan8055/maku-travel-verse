-- Critical Security Fix: Enhanced Admin Protection with Multiple Layers (Fixed v2)
...
-- Create secure user_roles table for proper role management if it doesn't exist
...
SET search_path TO ''
AS $$
  -- Use the ultra-secure admin check
