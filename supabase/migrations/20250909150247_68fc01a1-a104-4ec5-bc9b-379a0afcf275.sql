-- Add Master AI Bot and Maku Bot entries to gpt_bot_registry
...
(
  ...
  ARRAY['system_analysis', 'troubleshooting', 'predictive_analytics', 'performance_optimization', 'data_insights'],
  'System Management',
  'active',
  true,
  '{
...
(
  ...
  ARRAY['travel_planning', 'booking_assistance', 'destination_recommendations', 'travel_advice', 'vertical_specialization'],
  'Travel Assistance',
  'active',
  true,
  '{
...
(
  ...
  ARRAY['family_travel', 'kid_friendly_destinations', 'family_accommodations', 'group_activities'],
  'Travel Assistance',
  'active',
  true,
  '{
...
(
  ...
  ARRAY['solo_travel', 'safety_tips', 'solo_experiences', 'independent_travel'],
  'Travel Assistance',
  'active',
  true,
  '{
...
(
  ...
  ARRAY['pet_travel', 'pet_friendly_hotels', 'pet_activities', 'travel_regulations'],
  'Travel Assistance',
  'active',
  true,
  '{
...
(
  ...
  ARRAY['spiritual_travel', 'wellness_retreats', 'meditation_centers', 'sacred_destinations'],
  'Travel Assistance',
  'active',
  true,
  '{
