-- Fix the migration with correct table structures

-- Insert some sample notifications (using correct column names)
INSERT INTO public.notifications (user_id, type, title, message, priority)
VALUES 
  ('00000000-0000-0000-0000-000000000000', 'system', 'System Maintenance', 'Scheduled maintenance completed successfully', 'medium'),
  ('00000000-0000-0000-0000-000000000000', 'security', 'Security Update', 'New security patches have been applied', 'high'),
  ('00000000-0000-0000-0000-000000000000', 'info', 'Welcome', 'Welcome to MAKU Travel admin dashboard', 'low');
