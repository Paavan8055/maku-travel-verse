...
### Test 1: Health Check
```bash
curl https://smart-dreams-hub.preview.emergentagent.com/api/ai-pro/health
...
### Test 2: Smart Dreams
```bash
curl -X POST https://smart-dreams-hub.preview.emergentagent.com/api/ai-pro/smart-dreams \
...
### Test 3: Travel DNA
```bash
curl -X POST https://smart-dreams-hub.preview.emergentagent.com/api/ai-pro/travel-dna \
  -H "Content-Type: application/json" \
  -d '{
    "user_id": "test_user_123",
    "bookings": [
