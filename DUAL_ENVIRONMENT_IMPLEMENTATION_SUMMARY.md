...
```bash
# Get configuration
curl https://maku-smart-dreams.preview.emergentagent.com/api/environment/config

# Switch environment
curl -X POST https://maku-smart-dreams.preview.emergentagent.com/api/environment/switch \
