...
1. **Lovable State**
   ...
   - URL: `https://smartjourney-6.preview.emergentagent.com`
   - Source: `lovable`
...
```bash
# Get configuration
curl https://smartjourney-6.preview.emergentagent.com/api/environment/config

# Switch environment
curl -X POST https://smartjourney-6.preview.emergentagent.com/api/environment/switch \
