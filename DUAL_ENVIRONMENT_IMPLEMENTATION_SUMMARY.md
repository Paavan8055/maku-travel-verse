...
1. **Lovable State**
   ...
   - URL: `https://maku-fund.preview.emergentagent.com`
   - Source: `lovable`
...
```bash
# Get configuration
curl https://maku-fund.preview.emergentagent.com/api/environment/config

# Switch environment
curl -X POST https://maku-fund.preview.emergentagent.com/api/environment/switch \
