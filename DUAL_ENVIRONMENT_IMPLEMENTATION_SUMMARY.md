...
1. **Lovable State**
   ...
   - URL: `https://yield-optimize.preview.emergentagent.com`
   - Source: `lovable`
...
```bash
# Get configuration
curl https://yield-optimize.preview.emergentagent.com/api/environment/config

# Switch environment
curl -X POST https://yield-optimize.preview.emergentagent.com/api/environment/switch \
