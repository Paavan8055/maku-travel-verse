...
1. **Lovable State**
   ...
   - URL: `https://travel-tech-audit.preview.emergentagent.com`
   - Source: `lovable`

2. **Emergent State**
   - Enhanced with CTO recommendations
   - Performance optimizations planned
   - URL: `https://travel-tech-audit-emergent.preview.emergentagent.com`
   - Source: `emergent`
...
```bash
# Get configuration
curl https://travel-tech-audit.preview.emergentagent.com/api/environment/config

# Switch environment
curl -X POST https://travel-tech-audit.preview.emergentagent.com/api/environment/switch \
