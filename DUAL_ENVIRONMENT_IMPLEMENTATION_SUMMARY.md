...
```bash
# Get configuration
curl https://social-journey-1.preview.emergentagent.com/api/environment/config

# Switch environment
curl -X POST https://social-journey-1.preview.emergentagent.com/api/environment/switch \
