...
1. **Lovable State**
   ...
   - URL: `https://maku-wallet.preview.emergentagent.com`
   - Source: `lovable`
...
```bash
# Get configuration
curl https://maku-wallet.preview.emergentagent.com/api/environment/config

# Switch environment
curl -X POST https://maku-wallet.preview.emergentagent.com/api/environment/switch \
